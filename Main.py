...
parser.add_argument('--ARR', type=float, default=0.001,
                    help='The adjacent rating regularizer. If not 0, regularize the \
...
Explanations of the above preprocessing:
    ...
    They are transformed to rating labels 0, 1, 2... ascending.
    ...
    But the numbers in adj_train are rating labels + 1, why? Because to accommodate 
...
if False:
    ...
    total_params = sum(p.numel()
                       for param in model.parameters() for p in param)
